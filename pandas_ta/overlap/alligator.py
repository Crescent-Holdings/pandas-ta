...
def alligator(
    ...
    gator_jaw = gator_jaw.shift(v_pos_default(offset, 8))
    gator_teeth = gator_teeth.shift(v_pos_default(offset, 5))
    gator_lips = gator_lips.shift(v_pos_default(offset, 3))
